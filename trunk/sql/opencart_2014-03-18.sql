...
# Database: opencart
# Generation Time: 2014-03-17 19:14:38 +0000
# ************************************************************
...
INSERT INTO `oc_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`)
VALUES
	(28,1,'Monitors','','',''),
	(33,1,'Cameras','','',''),
	(32,1,'Web Cameras','','',''),
...
VALUES
	(1,'Pound Sterling','GBP','£','','2',0.60119998,1,'2014-03-17 18:09:58'),
	(2,'US Dollar','USD','$','','2',1.00000000,1,'2014-03-17 18:45:53'),
	(3,'Euro','EUR','','€','2',0.71829998,1,'2014-03-17 18:09:58');
...
INSERT INTO `oc_information_description` (`information_id`, `language_id`, `title`, `description`)
VALUES
	(4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n'),
...
# Dump of table oc_news_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oc_news_category`;

CREATE TABLE `oc_news_category` (
...
# Dump of table oc_news_category_description
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oc_news_category_description`;

CREATE TABLE `oc_news_category_description` (
...
# Dump of table oc_news_category_to_layout
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oc_news_category_to_layout`;

CREATE TABLE `oc_news_category_to_layout` (
  `news_category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
# Dump of table oc_news_category_to_store
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oc_news_category_to_store`;

CREATE TABLE `oc_news_category_to_store` (
  `news_category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`news_category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
# Dump of table oc_news_comment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oc_news_comment`;

CREATE TABLE `oc_news_comment` (
...
# Dump of table oc_news_description
# ------------------------------------------------------------
...
# Dump of table oc_news_to_category
# ------------------------------------------------------------
...
# Dump of table oc_news_to_layout
# ------------------------------------------------------------
...
# Dump of table oc_news_to_store
# ------------------------------------------------------------
...
# Dump of table oc_product_profile
# ------------------------------------------------------------
...
# Dump of table oc_profile_description
# ------------------------------------------------------------
...
VALUES
	...
	(133,0,'config','config_encryption','3e1e3d2e84fbc6a1d3e7b02fcf630744',0),
	...
	(131,0,'config','config_email','buivantienduc@yahoo.com',0),
	...
	(132,0,'config','config_url','http://localsite/opencart-1.5.6.1/upload/',0);
...
VALUES
	(1,1,'admin','b8fcd2dd1e5c6ffc98d9defea6833fba187e313c','9ab949046','','','buivantienduc@yahoo.com','','127.0.0.1',1,'2014-03-18 01:09:16');
